package com.dinesh.springbootkafkaavro.config;
...
public class KafkaConsumerConfig {
    ...
    // --- 2. AVRO CONSUMER ---
    @Bean
    public ConsumerFactory<String, OrderMessage> avroConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
    ...
    public ConcurrentKafkaListenerContainerFactory<String, OrderMessage> avroKafkaListenerContainerFactory() {
